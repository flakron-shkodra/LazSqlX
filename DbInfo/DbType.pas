...
type
 ...
 public
  ...
  private
   ...
   procedure SetDbEngine(AValue: TDatabaseEngine);
 ...
 TDbUtils = object
  ...
  public
    ...
    {Gets db Tables for given scheme using Zeos}
    class procedure GetTablenames(DbInfo:TDbConnectionInfo; schema:string; var list:TStringList);

    {Gets column names from db using Zeos}
    class procedure GetColumnNames(DbInfo:TDbConnectionInfo; tablename:string; var list:TStringList);overload;
...
begin
  ExecuteQuery(SqlQuery,DbInfo,DbInfo.DbEngine);
end;
...
procedure TDbConnectionInfo.SetDbEngine(AValue: TDatabaseEngine);
begin
