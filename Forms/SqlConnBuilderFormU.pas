...
uses
  ...
  Dialogs, StdCtrls, Buttons, ExtCtrls, Utils, ZConnection, TableInfo,DbType, strutils,
  types, LCLType, Spin, EditBtn, Menus,IniFiles;
...
begin
  ...
  try
    ...
    try
      ...
      if RecentConnections.Count>10 then
      begin
