...
begin
  ...
  case QueryType of
    ...
    qtInsert:
    begin
      r.Add(strIdent + 'INSERT INTO ' + SqlOpenBr + _schema +
        SqlCloseBr + SqlFromDot + SqlOpenBr + TableInfo.TableName + SqlCloseBr);
      r.Add(strIdent + '(');
    ...
    qtUpdate:
    begin
      r.Add(strIdent + 'UPDATE ' + SqlOpenBr + _schema +
        SqlCloseBr + SqlFromDot + SqlOpenBr + TableInfo.TableName + SqlCloseBr);
      r.Add(strIdent + 'SET ');
    ...
    qtDelete:
    begin
      r.Add(strIdent + 'DELETE FROM ' + SqlOpenBr + _schema +
        SqlCloseBr + SqlFromDot + SqlTable);
      if TableInfo.PrimaryKeys.Count > 0 then
      begin
        r.Add(strIdent + 'WHERE ' + SqlOpenBr + SqlTable + SqlCloseBr +
          SqlDot + SqlOpenBr + TableInfo.PrimaryKeys[0].FieldName +
