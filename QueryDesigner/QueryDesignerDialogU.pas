...
uses
  ...
  TableInfo, QueryDesignerU, Buttons,
...
type
  ...
  public
    ...
    function ShowModal(Con:TZConnection;
...
begin
  ...
  FDbConnection.GetColumnNames(cmbForeignTable.Items[cmbForeignTable.ItemIndex],'',cmbValueMember.Items);
...
begin
  ...
  FDbConnection.GetTableNames(FDBSchema,'',cmbForeignTable.Items);

  FDbConnection.GetColumnNames(FSourceTable,'',cmbSourceField.Items);
...
function TQueryDesignerDialog.ShowModal(Con: TZConnection; Schema, SourceTable,
 SourceField, ForiegnTable, ForeignKeyField: string; aSelectFields: TStringList
 ): TModalResult;
begin
  FDBSchema := Schema;
